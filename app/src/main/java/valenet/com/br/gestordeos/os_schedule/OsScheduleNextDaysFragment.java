 ...
 */
public class OsScheduleNextDaysFragment extends Fragment implements MainActivity.navigateInterface, Main.MainView {
    ...
    public OsScheduleNextDaysFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_os_schedule_next_days, container, false);
        ...
        if (this.ordemDeServicoList == null || this.ordemDeServicoList.size() == 0) {
            ...
            hideEmptyListView();
            showLoading();
            loadScheduleListOs(ordemDeServicoList);
        }
        ...
        if (ordemDeServicoArrayList != null && ordemDeServicoArrayList.size() > 0) {
            ...
            for (int i = 0; i < ordemDeServicoArrayList.size(); i++) {
                ...
                if (ordemDeServico.getDataAgendamento() != null) {
                    ...
                    if (DateUtils.isDateNextDays(currentDate, osDate))
