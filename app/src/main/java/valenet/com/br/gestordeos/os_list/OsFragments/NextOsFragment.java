...
public class NextOsFragment extends Fragment implements OsList.OsListView, OsListActivity.navigateInterface, OsListActivity.onActivityResultNextOs {
    ...
    @BindView(R.id.refresh_layout_next_os)
    SwipeRefreshLayout refreshLayoutNextOs;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_next_os, container, false);
        ...
        refreshLayoutNextOs.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
